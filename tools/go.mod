module github.com/douyu/jupiter-layout/tools
...
require (
	...
	github.com/douyu/jupiter v0.11.19
	...
	gorm.io/gen/tools/gentool v0.0.1
)
...
require (
	...
	github.com/hnlq715/struct2interface v0.1.5 // indirect
