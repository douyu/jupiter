...
const (
	...
	xhttpPkg           = protogen.GoImportPath("github.com/douyu/jupiter/pkg/util/xhttp")
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	g.P("// Code generated by github.com/douyu/jupiter-layout/cmd/protoc-gen-go-echo. DO NOT EDIT.")
	g.P()
	g.P("package ", file.GoPackageName)
	g.P()
	g.P("// This is a compile-time assertion to ensure that this generated file")
	g.P("// is compatible with the douyu/jupiter-layout/cmd/protoc-gen-go-echo package it is being compiled against.")
	g.P("// ", httpPkg.Ident(""), contextPkg.Ident(""), metadataPkg.Ident(""))
	g.P("// ", echoPkg.Ident("echo"), xhttpPkg.Ident(""))
	g.P()
