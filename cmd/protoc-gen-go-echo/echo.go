...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	g.P("// Code generated by github.com/douyu/jupiter/cmd/protoc-gen-go-echo. DO NOT EDIT.")
	g.P("// versions:")
	g.P(fmt.Sprintf("// - protoc-gen-go-echo %s", version))
	g.P("// - protoc             ", protocVersion(gen))
	g.P()
	g.P("package ", file.GoPackageName)
	g.P()
	g.P("// This is a compile-time assertion to ensure that this generated file")
	g.P("// is compatible with the github.com/douyu/jupiter/cmd/protoc-gen-go-echo package it is being compiled against.")
	g.P("var _ = ", httpPkg.Ident("StatusOK"))
	g.P("var _ = new(", contextPkg.Ident("Context"), ")")
	g.P("var _ = ", metadataPkg.Ident("New"))
	g.P("var _ = ", echoPkg.Ident("DefaultBinder"), "{}")
	g.P()
